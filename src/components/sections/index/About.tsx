...
export default function About() {
  ...
  useEffect(() => {
    const socket = new WebSocket(`wss://api.vesly.dev/kitty/presence?fields=activities.name,activities.title,activities.details,activities.state,activities.assets.largeImage,activities.timestamps`)
